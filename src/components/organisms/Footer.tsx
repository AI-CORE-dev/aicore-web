            ...
            <div className={styles._wave}>
                <div className={styles._container_social}>
                    <div className={styles._container_copy}>
                        <p className={styles._copyrigth}>Copyright © 202A AI CORE SAS</p>
                        <p className={styles.__copyrigth_text}>
                            La documentación y otro material publicado o reproducido sobre este
                            sitio es de propiedad de AICORE quedando expresamente prohibida su
