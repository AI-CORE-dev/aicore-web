...
export const CCLIENTS = [
...

    {
        ...
        job: 'CEO & CTO',
        company: 'Sodtrack',
        review: '"Desarrollamos nuestra plataforma junto a AI CORE. En el proyecto destaco su velocidad de respuestas y calidad en sus entregas. Siempre hubo alguien del equipo brindando el seguimiento para garantizar que nuestras expectativas se cumplan."',
        score: 5,
